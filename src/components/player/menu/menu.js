...
const Menu = ({API, changeContextURI, contextURI}) => {
    ...
    return(
        <div className="menu">
            ...
            <div className='menu-playlist-button'><i className="fa fa-plus mr-10"></i><a href='https://github.com/jakeroseboro' className='menu-link'>Other Works</a></div>
            <div className='menu-playlist-button'><i className="fa fa-thumbs-up mr-10"></i><a href='https://jacobroseboro.tech' className='menu-link'>View my website</a></div>
